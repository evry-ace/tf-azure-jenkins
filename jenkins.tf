...
resource "null_resource" "eula-accept" {
  provisioner "local-exec" {
    command = "az vm image accept-terms --urn ${azurerm_virtual_machine.ace-jenkins-vm.storage_image_reference.publisher}:${azurerm_virtual_machine.ace-jenkins-vm.storage_image_reference.offer}:${azurerm_virtual_machine.ace-jenkins-vm.storage_image_reference.sku}:${azurerm_virtual_machine.ace-jenkins-vm.storage_image_reference.version}"
  }
}
...
resource "azurerm_virtual_machine" "ace-jenkins-vm" {
    ...
    depends_on                   = ["null_resource.eula-accept"]
